...
const WithdrawPage = () => {
  ...
  const checkUserHasPaidInvestment = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://investify-api.duckdns.org/api/investments/user/${user._id}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://investify-api.duckdns.org/api/withdrawals/request`, {
        method: "POST",
        headers: { 
