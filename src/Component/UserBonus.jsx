...
const UserBonus = () => {
  ...
  const checkCode = async () => {
    ...
    setChecking(true);
    try {
      const res = await fetch("https://investify-fixed.vercel.app/api/bonus-code/check", {
        method: "POST",
  ...
  const claimBonus = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://investify-fixed.vercel.app/api/bonus-code/claim", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          userId: user?._id,
