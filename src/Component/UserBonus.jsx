...
const UserBonus = () => {
  ...
  const checkCode = async () => {
    ...
    setChecking(true);
    try {
      const res = await fetch("https://backend-project-invest.vercel.app/api/bunos/check", {
        method: "POST",
  ...
  const claimBonus = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://backend-project-invest.vercel.app/api/bunos/claim", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          userId: user?._id,
