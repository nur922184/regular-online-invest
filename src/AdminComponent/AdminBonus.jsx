...
const AdminBonus = () => {
  ...
  const fetchCodes = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://backend-project-invest.vercel.app/api/bunos/admin/all");
  ...
  const generateCode = async () => {
    try {
      setGenerating(true);
      const res = await fetch("https://backend-project-invest.vercel.app/api/bunos/admin/generate", {
        method: "POST",
  ...
  const deleteCode = async (id, code) => {
    ...
    try {
      const res = await fetch(`https://backend-project-invest.vercel.app/api/bunos/admin/delete/${id}`, {
        method: "DELETE"
      });
  ...
  const toggleStatus = async (id, currentStatus) => {
    try {
      const res = await fetch(`https://backend-project-invest.vercel.app/api/bunos/admin/toggle/${id}`, {
        method: "PUT"
      });
