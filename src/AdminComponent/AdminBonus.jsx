...
const AdminBonus = () => {
  ...
  const fetchCodes = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://investify-fixed.vercel.app/api/bonus-code/admin/all");
  ...
  const generateCode = async () => {
    try {
      setGenerating(true);
      const res = await fetch("https://investify-fixed.vercel.app/api/bonus-code/admin/generate", {
        method: "POST",
  ...
  const deleteCode = async (id, code) => {
    ...
    try {
      const res = await fetch(`https://investify-fixed.vercel.app/api/bonus-code/admin/delete/${id}`, {
        method: "DELETE"
      });
  ...
  const toggleStatus = async (id, currentStatus) => {
    try {
      const res = await fetch(`https://investify-fixed.vercel.app/api/bonus-code/admin/toggle/${id}`, {
        method: "PUT"
      });
