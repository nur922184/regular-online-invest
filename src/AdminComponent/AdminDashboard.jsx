...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // ইউজার স্ট্যাটস
      const userRes = await fetch("https://investify-fixed.vercel.app/api/users/admin/dashboard");
      ...
      // ট্রানজেকশন স্ট্যাটস
      const transRes = await fetch("https://investify-fixed.vercel.app/api/transactions/all");
      const transData = await transRes.json();
      const transactions = transData.transactions || [];
      
      // উইথড্র স্ট্যাটস
      const withdrawRes = await fetch("https://investify-fixed.vercel.app/api/withdrawals/admin/all");
      const withdrawData = await withdrawRes.json();
      const withdrawals = withdrawData.withdrawals || [];
      
      // ইনভেস্টমেন্ট স্ট্যাটস
      const investRes = await fetch("https://investify-fixed.vercel.app/api/investments/all");
